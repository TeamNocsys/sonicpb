...
type SonicVlan_VlanMember_VlanMemberList struct {
	...
	TaggingMode SonicTypesVlanTaggingMode `protobuf:"varint,1,opt,name=tagging_mode,json=taggingMode,proto3,enum=sonic.SonicTypesVlanTaggingMode" json:"tagging_mode,omitempty"`
}
...
func (x *SonicVlan_VlanMember_VlanMemberList) GetTaggingMode() SonicTypesVlanTaggingMode {
	if x != nil {
		return x.TaggingMode
	}
	return SonicTypesVlanTaggingMode_SONICTYPESVLANTAGGINGMODE_UNSET
}
...
var file_sonic_vlan_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x8d, 0x18, 0x0a, 0x09, 0x53, 0x6f, 0x6e, 0x69, 0x63, 0x56, 0x6c, 0x61, 0x6e,
	...
	0x4c, 0x69, 0x73, 0x74, 0x1a, 0xab, 0x04, 0x0a, 0x0a, 0x56, 0x6c, 0x61, 0x6e, 0x4d, 0x65, 0x6d,
	...
	0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x1a, 0x8f, 0x01, 0x0a, 0x0e, 0x56,
	0x6c, 0x61, 0x6e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x7d, 0x0a,
	0x0c, 0x74, 0x61, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x73, 0x6f, 0x6e, 0x69, 0x63, 0x2e, 0x53, 0x6f, 0x6e, 0x69,
	0x63, 0x54, 0x79, 0x70, 0x65, 0x73, 0x56, 0x6c, 0x61, 0x6e, 0x54, 0x61, 0x67, 0x67, 0x69, 0x6e,
	...
	0x0b, 0x74, 0x61, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x64, 0x65, 0x1a, 0x83, 0x02, 0x0a,
	...
	0x74, 0x2f, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x54, 0x0a, 0x10,
...
var file_sonic_vlan_proto_goTypes = []interface{}{
	...
	(SonicTypesVlanTaggingMode)(0),                               // 17: sonic.SonicTypesVlanTaggingMode
}
var file_sonic_vlan_proto_depIdxs = []int32{
	...
	13, // 7: sonic.SonicVlan.Vlan.VlanList.admin_status:type_name -> sonic.SonicTypesAdminStatus
	...
	16, // 14: sonic.SonicVlan.VlanInterface.VlanInterfaceIpprefixList.family:type_name -> sonic.SonicTypesIpFamily
	...
	17, // 19: sonic.SonicVlan.VlanMember.VlanMemberList.tagging_mode:type_name -> sonic.SonicTypesVlanTaggingMode
